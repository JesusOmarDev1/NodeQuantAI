"""
clasificar_modelo.py - Clasificación de Riesgo Ganglionar (Multiclase)
======================================================================
...
from classification.scripts.optimizacion_classification import seleccionar_features_rfecv
